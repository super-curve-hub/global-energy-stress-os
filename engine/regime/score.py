...
def _weighted(
    df: pd.DataFrame, weights: dict[str, float], clip: float = 3.0
) -> pd.Series:
...
def compute_scores(df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["Shipping_Stress_Index"] = _weighted(
        out,
        {
    ...
    out["Energy_Supply_Stress_Index"] = _weighted(
        out,
        {
            "Brent_WTI_z": 0.20,
    ...
    out["Military_Escalation_Index"] = _weighted(
        out,
        {
    ...
    out["Physical_Supply_Stress_Index"] = _weighted(
        out,
        {
    ...
    out["Financial_Market_Stress_Index"] = _weighted(
        out,
        {
            "Oil_Vol_z": 0.25,
            "Rates_Vol_z": 0.20,
    ...
    out["News_Credibility_Index"] = _weighted(
        out,
        {
            "NLP_War_Intensity_z": 0.20,
    ...
    out["War_Premium_Score"] = _weighted(
        out,
        {
